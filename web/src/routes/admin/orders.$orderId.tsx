...
import OrderStatusBadge from '@/sections/admin/OrderStatusBadge'
import OrderStatusSelect from '@/sections/admin/OrderStatusSelect'
        ...
        <table className="w-full">
          ...
          <tfoot>
            <tr>
              ...
              <td className="pt-4 text-right">{formatCurrency(order.subtotal)}</td>
            </tr>
            <tr>
              <td colSpan={3} className="text-right text-gray-500">
                Envío
              </td>
              <td className="text-right">{formatCurrency(order.shippingCost)}</td>
            </tr>
            <tr>
              <td colSpan={3} className="text-right text-gray-500">
                IVA (21%)
