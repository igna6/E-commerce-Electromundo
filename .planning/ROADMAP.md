...
Plans:
- [ ] 09-01: Fix product prices and clean product names (title case, trim garbage)
- [ ] 09-02: Remove fake reviews, fake discounts, fake installments from all UI components
...
| 9. Data Cleanup | v1.0 | 0/2 | Not started | - |
